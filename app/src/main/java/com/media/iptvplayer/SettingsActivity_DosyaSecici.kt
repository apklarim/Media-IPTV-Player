...
class SettingsActivity : AppCompatActivity() {
    private val backupLauncher =
        registerForActivityResult(
            ...
            if (BackupManager.createBackup(this, uri)) {
                Toast.makeText(this, "Yedek oluşturuldu", Toast.LENGTH_LONG).show()
            } else {
                Toast.makeText(this, "Yedekleme başarısız", Toast.LENGTH_LONG).show()
            }
        }
